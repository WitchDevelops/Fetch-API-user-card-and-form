...
const ageInfo = document.createElement("h2");
const eyeInfo = document.createElement("h2");

// set the html value to the extracted data
heading.innerHTML = "Name: " + personName;
...
personDiv.appendChild(eyeInfo);
  ...
  return (
    <div id="person-card" class="container">
      ...
      <div id="person-img">
        <img src="https://picsum.photos/534/383?random=1.jpg"></img>
      </div>
      ...
      <button a href="./Person3">next profiles</button>
    </div>
  );
}
